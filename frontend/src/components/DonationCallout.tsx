    ...
    <section id="donate" className="donation-callout" aria-labelledby="donation-callout-title">
      <div className="donation-callout-inner">
          ...
          <div className="donation-progress">
            ...
            <div className="donation-progress-top">
              ...
              <span className="donation-progress-label">
                {loading ? ‘—‘ : `${percent}%`} of {loading ? ‘…’ : formatUsd(monthlyGoalUsd)} goal — {monthLabel}
              </span>
            </div>
            <div
              ...
              aria-valuemax={100}
            >
              <div className="donation-progress-fill" style={{ width: loading ? ‘0%’ : `${percent}%` }} />
            </div>
          </div>
        </div>
        ...
        <div className="donation-card">
          ...
          <div className="donation-amount-grid">
            {PRESET_AMOUNTS_USD.map((amt) => (
              <button
                ...
                onClick={() => { setSelected(amt); setCustomRaw(‘’) }}
              >
                {formatUsd(amt)}
              </button>
            ))}
          ...
          >
            {effectiveAmount ? `Give ${formatUsd(effectiveAmount)}` : ‘Select an amount’}
          </button>
        </div>
